...
export async function sendMessageToHelloApi({ message = "", attachments = [], channelDetail, chat_id, helloVariables = {}, voiceCall = false, demo_widget = false, widget_msg_id, replied_on, session_id }: { message?: string, attachments?: any, channelDetail?: any, chat_id?: string | number, helloVariables?: any, voiceCall?: boolean, demo_widget?: boolean, widget_msg_id?: string, replied_on?: string, session_id?: string }): Promise<any> {
